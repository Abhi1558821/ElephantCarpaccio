...
public class PriceCalculatorInteractorTest {
    ...
    public void setUp() throws Exception {
        ...
        priceCalculatorInteractor = new PriceCalculatorInteractor();

        stateTaxList = StateTax.createStateTaxList(stateTaxJson);

        itemA = new Item();
        itemA.setItemName("ITEM A");
        itemA.setItemQuantity(11);
        itemA.setItemUnitPrice(100);
        itemA.setStateTax(stateTaxList.get(0));
        itemList.add(itemA);
        ...
        itemB.setStateTax(stateTaxList.get(2));
        itemList.add(itemB);
    }
    ...
    public void testCalculatePrice() {
        ...
        assertEquals(4189, priceCalculatorInteractor.getPayableValue(itemList), 0);
    ...
    public void testCalculatTax() {
        ...
        assertEquals("Calculate total Tax Value of Item List", 212, priceCalculatorInteractor.getTotalTaxValue(itemList), 0);

    }

    @Test
    public void testCalculatTotalPayablePrice() {
        assertEquals("Calculate total price with tax and discount", 4189, priceCalculatorInteractor.getPayableValue(itemList), 0);
    }
